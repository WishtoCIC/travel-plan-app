...
export const sampleTrip: Trip = {
  ...
  locations: [
    ...
    { id: 'loc3', name: 'BE Grand Resort Bohol', address: 'BE Grand Drive, Brgy. Danao, Panglao Island, Bohol, 6340, Philippines', lat: 9.548933968595241, lng: 123.76461902802014, type: 'hotel' },
